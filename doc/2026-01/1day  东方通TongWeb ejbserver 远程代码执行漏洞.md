...
攻击者可以通过构造恶意的序列化数据，利用该接口的反序列化过程实现任意代码执行。在能够访问受影响服务端口的情况下，未经身份验证的远程攻击者可能触发该漏洞并在服务器上执行任意代码，获得服务器的完全控制权。  
...
7.0.0.0 <= 受影响版本 <= 7.0.4.9_M9  
  
6.1.7.0 <= 受影响版本 <= 6.1.8.13  
...
![](https://mmbiz.qpic.cn/mmbiz_png/zBdps5HcBF0NJRkzuVnia2jG0NX7cbxkcRVYgygCrCXeItPbvFCr3CMZiajxStibDGYquiaDjliacUibVibTayNDNjmLA/640?wx_fmt=png&from=appmsg "")  
...
![](https://mmbiz.qpic.cn/mmbiz_png/zBdps5HcBF0NJRkzuVnia2jG0NX7cbxkcUXIFCZJTQVcUcCLiarP48k5Va5Ax1nG7UADVMTGsibIz1rVibXplaicib9g/640?wx_fmt=png&from=appmsg "")  
...
![](https://mmbiz.qpic.cn/mmbiz_png/zBdps5HcBF0NJRkzuVnia2jG0NX7cbxkc5AobYCbq6FybgkaeT8SqMHrl2V26CC2qDoAIt11xCTAdsWCQ2l9K3w/640?wx_fmt=png&from=appmsg "")  
...
![](https://mmbiz.qpic.cn/mmbiz_jpg/zBdps5HcBF3czhqXQJA3g4kDaRCwREynZURXSwGwA7ercMG0OdzYAEbyIwElxbXqA8nZ4Qq6f192ia2R4Ife2GA/640?wx_fmt=jpeg&from=appmsg "")  
