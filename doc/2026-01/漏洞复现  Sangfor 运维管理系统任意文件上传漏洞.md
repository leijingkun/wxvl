...
Sangfor 运维管理系统 (OSM) 版本 3.0.8 存在一个严重的任意文件上传漏洞。该漏洞位于 /fort/trust/version/common/common.jsp 端点。该端点的请求未能强制执行身份验证或正确的文件类型验证。远程的、未认证的攻击者可以通过发送精心构造的HTTP POST请求上传恶意文件（例如.jsp web shell）。  
...
fofa语法  
```
body="/fort/login" && product="SANGFOR-运维安全管理系统"
```  
  
![](https://mmbiz.qpic.cn/mmbiz_png/zBdps5HcBF0ag3IxBZN56WGh0nyTbAW3QzztJXWzWibRiaExvibcoLq8mEHjughTTyricPgk98babGchQNDx1hpy3A/640?wx_fmt=png&from=appmsg "")  
...
![](https://mmbiz.qpic.cn/mmbiz_png/zBdps5HcBF0ag3IxBZN56WGh0nyTbAW3kOzs8uc0QUHYsawNmrAyuFoMtyT4n2EfcZ5N5y3GhtYzA9HJia7Z1Nw/640?wx_fmt=png&from=appmsg "")  
  
访问文件  
  
![](https://mmbiz.qpic.cn/mmbiz_png/zBdps5HcBF0ag3IxBZN56WGh0nyTbAW3UgwyEbIxhew1peCG5PFrXqmvcp1b66sxfiakL8ib7UibnIJavN9TCPtSw/640?wx_fmt=png&from=appmsg "")  
...
![](https://mmbiz.qpic.cn/mmbiz_png/zBdps5HcBF0ag3IxBZN56WGh0nyTbAW3iaAkibibTyf4eZqGs8Md4arPnxYQbycbIPH9CjDQPcuXJTBVm7BCRj6dQ/640?wx_fmt=png&from=appmsg "")  
